...
class F1ScoreAdapter(tf.keras.metrics.Metric):
    """
    Адаптер для вычисления F1-score для конкретного класса с улучшенной обработкой тензоров
    """
    ...
    def update_state(self, y_true, y_pred, sample_weight=None):
        ...
        # Вычисляем метрики с учетом sample_weight
    ...
    def result(self):
        # Безопасное вычисление precision и recall
